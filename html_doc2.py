...
# ======================================================================
# html_doc2.py - Composition
# ======================================================================

# In this code, instead of printing the html code, we will save it to a file
# We do this on the def display() method where we add file=None as shown
# def display(self, file=None):
# print(self, file=file)

# Then we do the same in Body() class and HtmlDoc() class
...
# When you run this code, it will create a new file on the left named "test.html"
# Right click it > Open with browser
# It will open a new page created with the html code generated

# ==========================================================================
# We have now seen how to use "Composition" and " inheritance in above code:
# ==========================================================================
